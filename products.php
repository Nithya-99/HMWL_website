...
<body style="background-image: url('./images/img4.jpg'); z-index: 2;">
	...
	<div class="product" style="height: 220rem;height: auto;">
		<h2 class="text-center" style="color: #fff;">Products</h2>
	...
	<div class="footer1" style="position: relative; bottom: 0; z-index: 3;background:#000 !important;">
